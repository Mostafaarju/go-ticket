    ...
    return (
        <div className="position-sticky w-100 pt-3">
            ...
            <Navbar collapseOnSelect expand="lg" bg="transparent" variant={`light`}>
                <Link to="/home" className={`text-decoration-none font-weight-bold special-text`}>GO Ticket</Link>
                <Navbar.Toggle className="custom-toggler mt-1" aria-controls="responsive-navbar-nav" />
                <Navbar.Collapse id="responsive-navbar-nav">
                    
                    <Nav className="m-auto margin-left">
                        ...
                        <Link className={`link-btn mr-auto text-decoration-none `} to="/contact">Contact</Link>
                        {
                            ...
                            : <Link className={`link-btn mr-auto text-decoration-none mr-auto link-active`} to="/login">Login</Link>
                        }
